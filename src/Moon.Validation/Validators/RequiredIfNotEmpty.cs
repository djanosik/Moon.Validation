...
namespace Moon.Validation
{
    ...
    public class RequiredIfNotEmpty : DependentValidator, IValidatorNameProvider
    {
        private readonly RequiredAttribute reqValidator = new RequiredAttribute();

        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredIfNotEmpty" /> class.
        /// </summary>
        /// <param name="otherProperty">The property the validator is dependent on.</param>
        public RequiredIfNotEmpty(string otherProperty)
            : base(otherProperty)
        {
        }
