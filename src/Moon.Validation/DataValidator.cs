...
namespace Moon.Validation
{
    ...
    public class DataValidator
    {
        ...
        /// </param>
        public bool IsValid<TInstance>(TInstance instance, params Expression<Func<TInstance, object>>[] properties)
        ...
        /// An array of properties to test. It can be empty, but cannot be null.
        /// </param>
        public bool IsValid(object instance, params string[] propertyNames)
        ...
        /// An array of properties to test. It can be empty, but cannot be null.
        /// </param>
        public IEnumerable<ValidationResult> Validate<TInstance>(TInstance instance, params Expression<Func<TInstance, object>>[] properties) where TInstance : class
        {
            Requires.NotNull(instance, nameof(instance));
        ...
        /// An array of properties to test. It can be empty, but cannot be null.
        /// </param>
        public IEnumerable<ValidationResult> Validate(object instance, params string[] propertyNames)
        {
            Requires.NotNull(instance, nameof(instance));
        ...
        ValidationContext CreateObjectContext(object instance)
        {
        ...
        ValidationContext CreatePropertyContext(ValidationContext objectContext, string propertyName)
        {
        ...
        IEnumerable<PropertyToValidate> GetPropertiesToValidate(ValidationContext objectContext)
        {
        ...
        IEnumerable<PropertyToValidate> GetPropertiesToValidate(ValidationContext objectContext, params string[] propertyNames)
        {
        ...
        IEnumerable<ValidationResult> GetResults(object value, ValidationContext validationContext, IEnumerable<ValidationAttribute> attributes)
        {
            var results = new List<ValidationResult>();
        ...
        bool TryValidate(object value, ValidationContext validationContext, ValidationAttribute attribute, out ValidationResult result)
        {
        ...
        IEnumerable<ValidationResult> ValidateObject(ValidationContext objectContext)
        {
            var results = new List<ValidationResult>();
        ...
        IEnumerable<ValidationResult> ValidateProperties(ValidationContext objectContext)
        {
            var results = new List<ValidationResult>();
        ...
        IEnumerable<ValidationResult> ValidateProperties(ValidationContext objectContext, params string[] propertyNames)
        {
            var results = new List<ValidationResult>();
